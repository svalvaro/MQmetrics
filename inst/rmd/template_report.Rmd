...
files <- ReadDataFromDir(MQPathCombined, remove_contaminants = params$remove_contaminants) 
...
MaxQuantAnalysisInfo(MQPathCombined,
                      runningTimes, 
                      parameters) 
```
...
if( parameters$Value[parameters$Parameter == 'Match between runs'] == "True"){
