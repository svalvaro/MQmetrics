...
params:
  ...
  # upper limit cutoff, to remove unomidified, oxidation
  # table parameter in same file or new file, maybe the best is in another output. 
...
\newpage
```{r PTM, fig.height=8, fig.width=7.2, echo = FALSE}
