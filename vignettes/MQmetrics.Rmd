...
The function **PlotProteinCoverageAll()** takes as input the proteinGroups.txt table and returns a plot that shows the number of proteins identified in the samples.

```{r protein_coverage_all, fig.height=7.2, fig.width=7.2}
PlotProteinCoverageAll(proteinGroups = proteinGroups)
