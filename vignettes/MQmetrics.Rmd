...
%\VignetteIndexEntry{MQmetrics}
  ...
  [MaxQuant](https://pubmed.ncbi.nlm.nih.gov/27809316/) output tables, 
  ...
  It also includes two functions to visualize the [iRT peptides from Biognosys](https://biognosys.com/product/irt-kit/) in case they were spiked 
  in the samples.
...
The parameters can be adjusted to select the minimun number of peptides
...
The function **ReadDataFromDir()** takes as input the path to the *combined*
